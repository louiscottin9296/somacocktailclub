export const translations = {
  en: {
    ...
    footer: {
      ...
      faq: [
        { question: "Is your service limited to cocktails?", answer: "Not at all! In addition to our signature cocktails, we offer a full range of beverages, including wine, champagne, beer, mocktails, and non-alcoholic options to suit every guest's preference." },’s preference."" },
